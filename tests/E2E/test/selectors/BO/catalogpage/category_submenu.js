...
//    description_textarea: '#category_form  div.mce-tinymce mce-container mce-panel ',
    ...
    keyswords: '#fieldset_0 input[placeholder="Add"] tag:nth-child(1)',
    ...
    search_result: '#table-category td:nth-child(3)',
    update_button: '#table-category td:nth-child(7) div div',
    action_button: '#table-category td:nth-child(7) button .dropdown-toggle',
    delete_button: '#table-category td:nth-child(7) a [title="Delete"] ',
    ...
    parent_category: '#categories-tree span[contains(.,"%NAME")] input:nth-child(1)',

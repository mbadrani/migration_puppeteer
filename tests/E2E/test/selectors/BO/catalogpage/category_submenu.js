module.exports = {
  CategorySubMenu: {
    ...
    keyswords: '(#fieldset_0  input[placeholder="Add] tag )[1]',
    ...
    update_button: '#table-category  td[7] div div',
    action_button: '#table-category  td[7] button[contains(@class, "dropdown-toggle")]',
    delete_button: '#table-category  td[7] a [title="Delete"] ',
    view_button: '#table-category  td[7] a [title="View"] ',
    image_link: '#image-images-thumbnails  div img',
    thumb_link: '#thumb-images-thumbnails  div img',
    second_delete_button: '#content  form button[not(@name)]',
    select_category: '#table-category /tbody/tr/td[1]/input',
    action_group_button: '#form-category  div[contains(@class, "bulk-actions")]/button[contains(@class, "dropdown-toggle")]',
    delete_action_group_button: '#form-category  a [contains(@onclick, "Delete selected")]',
    category_number_span: '#form-category  span.badge ',
    category_description: '#category_form  div.mce-tinymce mce-container mce-panel ',
    description: '#table-category  td[4]',
    delete_tag_button: ' div.tagify-container  span[%POS]/a',
    ...
    category_name: '#table-category  tr[%ID] td[3]',
    category_view_button: '#table-category  tr[%ID] td[7] a [title="View"] ',
    category_id_column:'#table-category  tr[%ID] td[2]',

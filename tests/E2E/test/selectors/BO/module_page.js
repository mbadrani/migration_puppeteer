...
//#content  ul.breadcrumb.page-breadcrumb:nth-child(1) > li:nth-child(2)
    ...
    rollback_version: '#restoreBackupContainer option[2]',
    rollback_button: '#rollback ',
    success_msg: ' p .alert-success:nth-child(1) p',
    module_list: '#modules-list-container-all div[data-type="module" or data-type="service" ])[%I]',
    ...
    list_module: '#modules-list-container-all div[%I]',
    ...
    categories_element_option: '#main-div div[contains(aria-labelledby,"categories")] li[%ID]',
    categories_element_number_span: '#main-div div[contains(aria-labelledby,"categories")] li[%ID] span',
    see_more_by_category_link: '#main-div button[data-category="%ID" and contains(class,"see-more")]',
    ...
    price_module_span: '#modules-list-container-all div[data-type="module" or data-type="service"])[%I] div.module-price span',
    category_price_module_span: '#modules-list-container-all div[data-type="module" and data-categories="%IND"])[%I] div.module-price span',

module.exports = {
  ModulePage: {
    ...
    uninstall_button: 'form[action*="action/uninstall/%moduleTechName"] button[data-confirm_modal="module-modal-confirm-%moduleTechName-uninstall"]',    uninstall_confirmation: '//*[@id="module-modal-confirm-prestafraud-uninstall"]//a[contains(@class,"module_action_modal_uninstall")]',
